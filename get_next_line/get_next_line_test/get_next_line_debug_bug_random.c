...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/16 17:14:07 by cjulliar          #+#    #+#             */
/*   Updated: 2016/12/17 17:56:25 by cjulliar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*   Updated: 2016/12/16 16:58:48 by cjulliar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_lecture(int fd, char **line, int b)
{
	char	*txt;
	char	*tmp;
	char	*lect;
	...
	txt = ft_strdup("\0");
	if ((rep = (int*)malloc(sizeof(int) * 1)) == NULL)
		return (-1);
	*rep = 2;
...
int		ft_casparticulier(char **line, char **texte, char *text, size_t v)
{
	...
	if (v == 1)
	{
		*texte = ft_strsub(*texte, 1, ft_strlen(*texte) - 1);
		*line = "";
		return (1);
	}
	else if (v == 0)
